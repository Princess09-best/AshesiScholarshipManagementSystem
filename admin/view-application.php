...
<head>
  ...
  <title>ASMS||View Application</title>
  <!-- loader-->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div>
                    <?php
                    $vid=$_GET['viewid'];
$sql="SELECT tbluser.ID as uid,tbluser.FullName,tbluser.MobileNumber,tbluser.Email,tbluser.RegDate,tbluser.UserName,tblscheme.ID as sid,tblscheme.SchemeName,tblscheme.SchemeType,tblscheme.SchemeGrade,tblscheme.Yearofscholarship,tblscheme.Category,tblscheme.Criteria,tblscheme.DocomentRequired,tblscheme.LastDate,tblscheme.ScholarDesc,tblscheme.ScholarAmount,tblscheme.PublishedDate,tblapply.ID as appid,tblapply.ApplicationNumber,tblapply.ApplyDate,tblapply.Status,tblapply.DateofBirth,tblapply.Gender,tblapply.Category,tblapply.Major,tblapply.Address,tblapply.AshesiID,tblapply.ProfilePic,tblapply.DocReq,tblapply.Remark from tblapply join tbluser on tblapply.UserID=tbluser.ID join tblscheme on tblapply.SchemeId=tblscheme.ID where tblapply.ID = :vid";
$query = $db -> prepare($sql);
