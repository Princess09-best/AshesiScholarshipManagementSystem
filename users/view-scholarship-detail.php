...
echo "<script>window.location.href ='views-scholarships.php'</script>";
}
else
{


$sql="insert into tblapply(SchemeId,ApplicationNumber,UserID,DateofBirth,Gender,Category,Major,Address,AshesiID,ProfilePic,DocReq)values(:schemeid,:appnum,:uid,:dob,:gender,:category,:major,:address,:ashesiID,:pic,:doc)";
...
$query->bindParam(':ashesiID',$ashesiID,PDO::PARAM_STR);
...
<head>
  ...
  <title>ASMS||User View Scholarship</title>
  <!-- loader-->
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <table class="table table-bordered table-hover data-tables">
  ...
  <tr>
    <th style="color: #a53838;">Category :</th>
    <td>
   <select name="category" class="form-control" required="true" style="border:solid 1px #000;color:#000;">
    <option value="HighNeed" selected="true">HighNeed</option>
     <option value="MeduimNeed" >MeduimNeed</option>
     <option value="LowNeed">LowNeed</option>
     <option value="ExtremeNeed">ExtremeNeed</option>
   </select></td>
  </tr>
  <tr>
    <th style="color: #a53838;">Major :</th>
    <td>
   <input type="text" name="major" class="form-control" required="true" style="border:solid 1px #000;color:#000;"></td>
  </tr>
     <tr>
    <th style="color: #a53838;">Home Address :</th>
    <td>
    <textarea name="address" rows="4" cols="14" class="form-control" required="true" style="border:solid 1px #000;color:#000;"></textarea></td>
  </tr>  
  <tr>
    <th style="color: #a53838;">Upload Required Doc :</th>
    <td>
    <input type="file" name="reqdoc" value="" class="form-control" required="true" style="border:solid 1px #000;color:#000;"> </td>
  </tr> 
  <tr>
    <th style="color: #a53838;"> Ashesi ID :</th>
    <td>
    <input type="text" name="ashesiID" class="form-control" required="true" style="border:solid 1px #000;color:#000;"></td>
  </tr>
</table>
</div>
