...
<head>
  ...
  <title>ASMS||User View Scholarships</title>
  <!-- loader-->
...
{               ?>
                    <tr>
                                                ...
                                                <td><a href="view-scholarship-detail.php?viewid=<?php echo htmlentities ($row->ID);?>" class="btn btn-primary btn-sm">View Detail
                                                </a>
                                                </td>
                                            </tr>
                                    <?php $cnt=$cnt+1;}} ?>                    
