...
<html lang="en">
  <head>
    <title>ASMS</title>| Scholarship-details</title>
...
<?php include_once('includes/header.php');?>
    ...
    <div class="hero-wrap hero-wrap-2" style="background-image: url('images/image-2.jpg'); background-attachment:fixed;">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Scholarship Details</span></p>
            <h1 class="mb-3 bread">Scholarhip  Details</h1>
          </div>
        </div>
      </div>
    </div>
...
{               ?>
 ...
 <table class="table table-bordered">
    <tbody>
      ...
      <tr>
        <th>Scholarship required Grade</th>
